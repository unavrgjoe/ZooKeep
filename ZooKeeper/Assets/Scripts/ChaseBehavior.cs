...
public class ChaseBehavior : BehaviorSO
{
    ...
    {
        int my = ctrl.tier; Entity prey = null; var pos = (Vector2)ctrl.transform.position; float d2 = 0; //sorry for having a local prey separate from the one in AIController
